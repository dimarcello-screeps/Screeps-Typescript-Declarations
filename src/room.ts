...
declare class Room {
     ...
     */
    createFlag(x: number, y:number, name?: string, color?: number, secondaryColor?: number): string|number;
    /**
     * Create new Flag at the specified location.
     * @param pos Can be a RoomPosition object or any object containing RoomPosition.
     * @param name (optional) The name of a new flag. It should be unique, i.e. the Game.flags object should not contain another flag with the same name (hash key). If not defined, a random name will be generated.
     ...
     * @param secondaryColor The secondary color of a new flag. Should be one of the COLOR_* constants. The default value is equal to color.
     */
    createFlag(pos: RoomPosition|{pos: RoomPosition}, name?: string, color?: number, secondaryColor?: number): string|number;
    /**
